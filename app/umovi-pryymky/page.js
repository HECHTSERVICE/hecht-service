    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <ul style={{ paddingLeft: 20, marginBottom: 14 }}>
          {['Товар чистий, сухий, без забруднень', 'Максимально можлива заводська комплектація', 'Без механічних пошкоджень від неправильної експлуатації', 'Наявний документ про придбання (чек, накладна, сертифікат)', 'Чіткий опис проблеми'].map(i => <li key={i} style={li}>{i}</li>)}
        </ul>

        <h2 style={{ fontSize: 18, fontWeight: 600, color: 'var(--text)', marginTop: 36, marginBottom: 12 }}>3. Відмова у прийманні</h2>
        <ul style={{ paddingLeft: 20, marginBottom: 14 }}>
          {['Сильне забруднення або неприємний запах', 'Сліди самостійного ремонту', 'Пошкоджений або нечитабельний серійний номер', 'Ознаки використання не за призначенням', 'Відсутність документів'].map(i => <li key={i} style={li}>{i}</li>)}
        </ul>
